...
function Assignment1() {
  ...
  return (
    <>
      <nav style={{ margin: 10 }}>
        <Link to='/assignment-1/1' style={{ padding: 5 }}>
          Question1
        </Link>
        <Link to='/assignment-1/2' style={{ padding: 5 }}>
          Question2
        </Link>
        <Link to='/assignment-1/3' style={{ padding: 5 }}>
          Question3
        </Link>
        <Link to='/assignment-1/4' style={{ padding: 5 }}>
          Question4
        </Link>
        <Link to='/assignment-1/5' style={{ padding: 5 }}>
          Question5
        </Link>
        <Link to='/assignment-1/6' style={{ padding: 5 }}>
          Question6
        </Link>
      </nav>
